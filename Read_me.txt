...
If you want to find the structural features in new dataset, please
prepare your input file in the following format:


Disease/signaling Pathway	protein#1,protein#2,protein#3,...,protein#n,
---
---
---
---
...
Each row refers to signaling or disease pathway related to COVID-19 that separates by "\tab" and the name of candidate genes in pathway that separated by ','.
for example:
...
The output file  contains the set of all pathways and their structural features.
...
If you want to calculate the Laplacian Score values in new dataset, please
prepare your input file in the following format:
...
Each row refers to signaling or disease pathway related to COVID-19 that separates by ":" and six features of pathway are separated by ','.
You can use the output file of "Topological_Network.m" algorithm.
for example:
